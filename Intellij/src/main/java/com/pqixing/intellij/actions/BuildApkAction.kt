...
//            AdbShellCommandsUtil.executeCommand()
        ...
        GradleUtils.runTask(project, listOf(":${module!!.name}:PrepareDev", ":${module!!.name}:BuildApk"), activateToolWindowBeforeRun = false, runTaskId = runTaskId, callback = callBack)
    }
