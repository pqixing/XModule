...
open class InstallApkAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val install = IInstall { info, dialog, indicator, c ->
            ...
            GradleUtils.runTask(project, listOf(":${info.title}:PrepareDev", ":${info.title}:BuildApk"), activateToolWindowBeforeRun = true, envs = mapOf(Pair("include", ""), Pair("dependentModel", "")), callback = c)
        }
