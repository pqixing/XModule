                    ...
                    taskScheduler.addTask(new ITask() {
                        ...
                        Object call() throws Exception {
                            ...
                            if (jarInput.status == Status.REMOVED) {
                                ...
                                AJXUtils.filterJar(jarInput, variantCache, ajxExtensionConfig.includes, ajxExtensionConfig.excludes,ajxExtensionConfig.excludeJarByClassMatch)
                            ...
                            if (!variantCache.isIncludeJar(filePath)) {
                                ...
                                println("!!! Warning --------------------------->  exclude jar : $jarInput.name -> $jarInput.file.absolutePath")
                            }
                            return null
                        }
                    })
