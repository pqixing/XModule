...
class AndroidConfig extends com.pqixing.modularization.base.BaseExtension {
    ...
    LinkedList<String> getOutFiles() {
        def list = []
        ProjectInfo config = wrapper.getExtends(ProjectInfo.class)
        ...
        file.params += ["pluginName": config.runType?.asApp ? com.pqixing.modularization.Keys.NAME_APP : wrapper.pluginName]
