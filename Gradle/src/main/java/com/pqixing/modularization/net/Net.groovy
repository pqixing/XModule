...
//
//        String netResult = com.pqixing.modularization.gradle.modularization.FileUtils.readCache(url)
//        if (GlobalConfig.offlineMode) {
//            if (com.pqixing.modularization.gradle.modularization.CheckUtils.isEmpty(netResult)) throw new RuntimeException("offlineMode invail there is no cache for url :$url")
//            return netResult
//        }
//
//        if ((!com.pqixing.modularization.gradle.modularization.CheckUtils.isEmpty(netResult) && useCache)) return netResult
//
//        netResult = requestNet(url)
//        def cacheFile = com.pqixing.modularization.gradle.modularization.FileUtils.saveCache(url, netResult)
//        com.pqixing.modularization.gradle.modularization.Print.ln("requestNet -> url: $url cacheFile : file://$cacheFile.absolutePath")
//        return netResult
//    }
//    /**
//     * 读取网络
...
//            return result
//        } catch (Exception e) {
//            com.pqixing.modularization.gradle.modularization.Print.ln("requestNet -> e: ${e.toString()}")
//            return ""
//        }
//    }
//
...
//        pomUrl.append(com.pqixing.modularization.gradle.modularization.TextUtils.getUrl(buildConfig.groupName))
