...
//            field = value
//        }
//        get() = subModule?.attach?.let { args.dpsContainer[it.name]?.apiVersion }
...
//        when (split.size) {
//            1 -> {
//                inner.branch = subModule?.getBranch() ?: "master"
//                inner.name = split[0]
//                inner.version = ""
//            }
//            2 -> {
...
//        if (apiModule == null) {
//            if (!inner.module.isApplication) container.add(inner)
//            return
//        }
//        //先尝试加载
...
//        if (subModule != null && args.runAsApp(subModule!!) && !inner.module.isApplication && !inner.justApi) container.add(inner)
//    }
//
